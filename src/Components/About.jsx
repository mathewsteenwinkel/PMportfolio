    ...
    <section className="about-me">
      <div className="about-me-content">
        ...
        <div class="about-content">
          ...
          <p>I also spent time in the mountains—literally. Based in Canmore, Alberta, I'm an avid climber who founded the MacEwan University Climbing Club and currently work at Arc'teryx's first North American mountain store, where I contributed to over $1M in sales within six weeks. This outdoor background taught me about risk assessment, adaptability, and the importance of reliable gear when stakes are high—principles I apply to every product I build.</p>
